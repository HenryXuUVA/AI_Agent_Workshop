...
def create_graph(llm):
    ...
    def call_llm(state: AgentState) -> dict:
        ...
        """
        trace(state, f"node=call_llm entered (input={state['user_input']!r})")
        ...
        trace(state, f"node=call_llm completed (response_len={len(response)})")
    ...
    def print_response(state: AgentState) -> dict:
        ...
        """
        trace(state, f"node=print_response entered (response_len={len(state['llm_response'])})")
        print("\n" + "-" * 50)
        print("LLM Response:")
        print("-" * 50)
    ...
    #   3. User entered non-empty normal input -> proceed to call_llm
    def route_after_input(state: AgentState) -> str:
        ...
        Returns:
            ...
            - "call_llm": If user provided non-empty normal input
        """
        trace(
            state,
            "route_after_input "
        ...
        # Default: Proceed to LLM for non-empty, non-command input.
        return "call_llm"
